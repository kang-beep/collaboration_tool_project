...
from chat.models import Room, Team, TeamRoom, TeamMessage, PrivateMessage, PrivateRoom
...
def private_chat(request, username):
    ...
    room, created = PrivateRoom.objects.get_or_create(room_id=room_id)
    print(room_id)
    messages = PrivateMessage.objects.filter(room=room).order_by('timestamp')
